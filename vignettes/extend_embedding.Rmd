---
title: "Writing Your Own Embedding Algorithms"
...
The `lol` package makes it trivial for users to write their own embedding algorithms and leverage our functions.
