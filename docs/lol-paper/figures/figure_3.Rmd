...
sims <- list(lol.sims.rtrunk, lol.sims.toep, lol.sims.rtrunk, lol.sims.fat_tails, lol.sims.cross)
...
sim_names = c("Trunk-2", "Toeplitz", "Trunk-3", "Fat-Tails (D=1000)", "Cross")
...
algs <-  c("LOL", "QOL", "PLS", "CCA", "LDA", "PCA", "ROAD", "LASSO")
acols <- c("#f41711", "#f41711", "#94d6c9", "#87c6cc", "#99b4c6", "#020202", "#666666", "#666666")
linestyle <- c(1,3,3,1,3,1,1,3,1)
linestyle <- c("solid", "dotted", "dotted", "solid", "dotted", "solid", "solid", "dotted")
names(acols) <- algs
...
for (i in 1:length(sim_names)) {
  ...
  if (i != 5) {
    pt.dat <- pt.dat[pt.dat$alg != "QOL",]
    data_sub <- data_sub[data_sub$alg != "QOL",]
  }
