...
make_marginal_2d <- function(data, xlims, ylims, plot.title="", xl="", yl="", leg.title="",
  ...
  center <- ggplot(data, aes(x=rstar.norm, y=lhat.norm)) +
    ...
    geom_point(aes(x=rstar.norm, y=lhat.norm, shape=alg, fill=alg), alpha=0.4, size=1.2) +
    geom_point(data=data.medians, aes(x=rstar.norm, y=lhat.norm, shape=alg, fill=alg), alpha=1.0, size=2.5) +
  ...
  center_leg <- ggplot(data, aes(x=rstar.norm, y=lhat.norm)) +
    ...
    geom_point(aes(x=rstar.norm, y=lhat.norm, shape=alg, fill=alg), alpha=1.0, size=1.8) +
    scale_fill_manual(values=acols, guide=legend.style, name=leg.title) +
