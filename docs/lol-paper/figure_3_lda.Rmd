...
algs <-  c("LOL", "QOQ", "ROAD", "LASSO", "CCA", "PCA", "LDA")
acols <- c("#00FF00", "#00FF00", "#969696", "#969696", "#525252", "#525252", "#525252")
names(acols) <- algs
linestyle <- c("solid", "dashed", "solid", "dashed", "solid", "dashed", "dotted")
